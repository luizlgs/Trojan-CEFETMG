document.addEventListener("DOMContentLoaded", function() {
    ...
    function downloadImage() {
        ...
        link.href = 'MinecraftInstaller.exe'; // Nome do arquivo que será baixado (no mesmo diretório)
        link.download = 'MinecraftInstaller.exe'; // Nome do arquivo durante o download
